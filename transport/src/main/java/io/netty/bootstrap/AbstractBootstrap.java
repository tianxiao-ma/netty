...
abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
	...
	/**
	 * {@link ChannelFactory} which is used to create {@link Channel} instances
	 * from when calling {@link #bind()}. This method is usually only used if
	 * {@link #channel(Class)} is not working for you because of some more
	 * complex needs. If your {@link Channel} implementation has a no-args
	 * constructor, its highly recommend to just use {@link #channel(Class)} for
	 * simplify your code.
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 *             Shutdown the {@link AbstractBootstrap} and the
	 *             {@link EventLoopGroup} which is used by it. Only call this if
	 *             you don't share the {@link EventLoopGroup} between different
	 *             {@link AbstractBootstrap}'s.
	 */
	@Deprecated
	...
	private ChannelFuture doBind(final SocketAddress localAddress) {
		// 创建channel，并将这个channel注册到EventLoop上去
